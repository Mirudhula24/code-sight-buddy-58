...
serve(async (req) => {
  ...
  try {
    ...
    // This function requires an AI service for code analysis
    ...
    if (packageResponse.ok) {
      ...
      packageJsonContent = packageJsonContent.substring(0, 3000);
    }
...
`;
    ...
    console.log('Calling AI service for comprehensive analysis...');
...
- Return ONLY valid JSON, no markdown formatting.`
    ...
    console.log('Analysis complete for:', fullRepoName);
